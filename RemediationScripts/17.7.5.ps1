...
Write-Host "Applying CIS Control 17.7.5 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.7.5 (L1) Ensure 'Audit Other Policy Change Events' is set to include 'Failure'" -ForegroundColor White
    Write-Host ""
