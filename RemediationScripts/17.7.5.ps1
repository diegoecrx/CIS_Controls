<#
.SYNOPSIS
    CIS Control 17.7.5 - 17.7.5 (L1) Ensure 'Audit Other Policy Change Events' is set to include 'Failure'
...
Write-Host "CIS Control 17.7.5 - Audit Policy Configuration" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "This script will configure the following audit policy:" -ForegroundColor Yellow
Write-Host "  Subcategory: Other Policy Change Events" -ForegroundColor White
Write-Host "  Setting: Failure" -ForegroundColor White
Write-Host ""
Write-Host "This will enable auditing of Other Policy Change Events failure events." -ForegroundColor Yellow
Write-Host ""
...
try {
    ...
    $result = auditpol /set /subcategory:"Other Policy Change Events" /success:disable /failure:enable 2>&1
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        $verify = auditpol /get /subcategory:"Other Policy Change Events" 2>&1
        Write-Host $verify
        
        Write-Host ""
        Write-Host "CIS Control 17.7.5 applied successfully!" -ForegroundColor Green
    } else {
...
Write-Host "SUCCESS" -ForegroundColor Green
    ...
    Write-Host "Error applying CIS Control 17.7.5: $_" -ForegroundColor Red
