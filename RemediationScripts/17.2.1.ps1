<#
.SYNOPSIS
    CIS Control 17.2.1 - 17.2.1 (L1) Ensure 'Audit Application Group Management' is set to 'Success and Failure'
...
Write-Host "CIS Control 17.2.1 - Audit Policy Configuration" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "This script will configure the following audit policy:" -ForegroundColor Yellow
Write-Host "  Subcategory: Application Group Management" -ForegroundColor White
Write-Host "  Setting: Success and Failure" -ForegroundColor White
Write-Host ""
Write-Host "This will enable auditing of application group management events." -ForegroundColor Yellow
Write-Host ""
...
try {
    ...
    $result = auditpol /set /subcategory:"Application Group Management" /success:enable /failure:enable 2>&1
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        $verify = auditpol /get /subcategory:"Application Group Management" 2>&1
        Write-Host $verify
        
        Write-Host ""
        Write-Host "CIS Control 17.2.1 applied successfully!" -ForegroundColor Green
    } else {
    ...
    Write-Host "Error applying CIS Control 17.2.1: $_" -ForegroundColor Red
    exit 1
}
