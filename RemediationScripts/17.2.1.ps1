<#
.SYNOPSIS
    CIS Control 17.2.1 - 17.2.1 (L1) Ensure 'Audit Application Group Management' is set to 'Success and F
...
Write-Host "Applying CIS Control 17.2.1 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.2.1 (L1) Ensure 'Audit Application Group Management' is set to 'Success and Failure'" -ForegroundColor White
    Write-Host ""
