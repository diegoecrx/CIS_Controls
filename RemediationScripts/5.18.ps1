<#
.SYNOPSIS
    CIS Control 5.18 - 5.18 (L2) Ensure 'Remote Desktop Services (TermService)' is set to 'Disabled'
...
Write-Host "CIS Control 5.18" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 5.18 (L2) Ensure 'Remote Desktop Services (TermService)' is set to 'Disabled'" -ForegroundColor Yellow
Write-Host ""
