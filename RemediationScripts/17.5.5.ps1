<#
.SYNOPSIS
    CIS Control 17.5.5 - 17.5.5 (L1) Ensure 'Audit Other Logon/Logoff Events' is set to 'Success and Fail
...
Write-Host "Applying CIS Control 17.5.5 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.5.5 (L1) Ensure 'Audit Other Logon/Logoff Events' is set to 'Success and Failure'" -ForegroundColor White
    Write-Host ""
