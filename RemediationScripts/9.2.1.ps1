<#
.SYNOPSIS
    CIS Control 9.2.1 - 9.2.1 (L1) Ensure 'Windows Firewall: Private: Firewall state' is set to 'On (rec

.DESCRIPTION
    To establish the recommended configuration via GP, set the following UI path to On (recommended) :
 
Computer Configuration\Policies\Windows Settings\Security Settings\Windows Defender Firewall with Advanced Security\Windows Defender Firewall with Advanced Security\Windows Defender Firewall Properti...
...
Write-Host "CIS Control 9.2.1" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 9.2.1 (L1) Ensure 'Windows Firewall: Private: Firewall state' is set to 'On (recommended)'" -ForegroundColor Yellow
Write-Host ""
