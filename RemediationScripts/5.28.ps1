<#
.SYNOPSIS
    CIS Control 5.28 - 5.28 (L1) Ensure 'UPnP Device Host (upnphost)' is set to 'Disabled'
...
Write-Host "CIS Control 5.28" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 5.28 (L1) Ensure 'UPnP Device Host (upnphost)' is set to 'Disabled'" -ForegroundColor Yellow
Write-Host ""
