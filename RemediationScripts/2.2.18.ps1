<#
.SYNOPSIS
    CIS Control 2.2.18 - 2.2.18 (L1) Ensure 'Deny log on as a service' to include 'Guests'
...
Write-Host "CIS Control 2.2.18 - User Rights Assignment" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2.2.18 (L1) Ensure 'Deny log on as a service' to include 'Guests'" -ForegroundColor White
Write-Host ""
