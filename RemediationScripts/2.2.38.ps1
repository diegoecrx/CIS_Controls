<#
.SYNOPSIS
    CIS Control 2.2.38 - 2.2.38 (L1) Ensure 'Shut down the system' is set to 'Administrators, Users'
...
Write-Host "CIS Control 2.2.38 - User Rights Assignment" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2.2.38 (L1) Ensure 'Shut down the system' is set to 'Administrators, Users'" -ForegroundColor White
Write-Host ""
