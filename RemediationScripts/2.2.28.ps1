<#
.SYNOPSIS
    CIS Control 2.2.28 - 2.2.28 (L2) Ensure 'Log on as a batch job' is set to 'Administrators'

.DESCRIPTION
    To establish the recommended configuration via GP, set the following UI path to Administrators :
 
Computer Configuration\Windows Settings\Security Settings\Local Policies\User Rights Assignment\Log o...
...
Write-Host "CIS Control 2.2.28 - User Rights Assignment" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2.2.28 (L2) Ensure 'Log on as a batch job' is set to 'Administrators'" -ForegroundColor White
Write-Host ""
