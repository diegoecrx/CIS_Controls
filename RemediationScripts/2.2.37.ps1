<#
.SYNOPSIS
    CIS Control 2.2.37 - 2.2.37 (L1) Ensure 'Restore files and directories' is set to 'Administrators'

.DESCRIPTION
    To establish the recommended configuration via GP, set the following UI path to Administrators :
 
Computer Configuration\Policies\Windows Settings\Security Settings\Local Policies\User Rights Assignm...
...
Write-Host "CIS Control 2.2.37 - User Rights Assignment" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2.2.37 (L1) Ensure 'Restore files and directories' is set to 'Administrators'" -ForegroundColor White
Write-Host ""
