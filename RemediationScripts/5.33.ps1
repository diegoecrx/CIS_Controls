<#
.SYNOPSIS
    CIS Control 5.33 - 5.33 (L1) Ensure 'Windows Mobile Hotspot Service (icssvc)' is set to 'Disabled'
...
Write-Host "CIS Control 5.33" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 5.33 (L1) Ensure 'Windows Mobile Hotspot Service (icssvc)' is set to 'Disabled'" -ForegroundColor Yellow
Write-Host ""
