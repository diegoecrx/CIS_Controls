<#
.SYNOPSIS
    CIS Control 17.8.1 - 17.8.1 (L1) Ensure 'Audit Sensitive Privilege Use' is set to 'Success and Failur
...
Write-Host "Applying CIS Control 17.8.1 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.8.1 (L1) Ensure 'Audit Sensitive Privilege Use' is set to 'Success and Failure'" -ForegroundColor White
    Write-Host ""
