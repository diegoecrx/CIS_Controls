<#
.SYNOPSIS
    CIS Control 5.5 - 5.5 (L2) Ensure 'GameInput Service (GameInputSvc)' is set to 'Disabled'
...
Write-Host "CIS Control 5.5" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 5.5 (L2) Ensure 'GameInput Service (GameInputSvc)' is set to 'Disabled'" -ForegroundColor Yellow
Write-Host ""
