...
Write-Host "Applying CIS Control 17.6.1 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.6.1 (L1) Ensure 'Audit Detailed File Share' is set to include 'Failure'" -ForegroundColor White
    Write-Host ""
