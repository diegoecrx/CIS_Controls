<#
.SYNOPSIS
    CIS Control 5.41 - 5.41 (L1) Ensure 'Xbox Live Game Save (XblGameSave)' is set to 'Disabled'
...
Write-Host "CIS Control 5.41" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 5.41 (L1) Ensure 'Xbox Live Game Save (XblGameSave)' is set to 'Disabled'" -ForegroundColor Yellow
Write-Host ""
