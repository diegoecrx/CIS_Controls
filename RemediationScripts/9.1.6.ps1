<#
.SYNOPSIS
    CIS Control 9.1.6 - 9.1.6 (L1) Ensure 'Windows Firewall: Domain: Logging: Log dropped packets' is se
...
Write-Host "CIS Control 9.1.6" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 9.1.6 (L1) Ensure 'Windows Firewall: Domain: Logging: Log dropped packets' is set to 'Yes'" -ForegroundColor Yellow
Write-Host ""
