<#
.SYNOPSIS
    CIS Control 17.2.3 - 17.2.3 (L1) Ensure 'Audit User Account Management' is set to 'Success and Failur
...
Write-Host "Applying CIS Control 17.2.3 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.2.3 (L1) Ensure 'Audit User Account Management' is set to 'Success and Failure'" -ForegroundColor White
    Write-Host ""
