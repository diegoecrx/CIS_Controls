<#
.SYNOPSIS
    CIS Control 2.2.2 - 2.2.2 (L1) Ensure 'Access this computer from the network' is set to 'Administrat

.DESCRIPTION
    To establish the recommended configuration via GP, set the following UI path to Administrators, Remote Desktop Users :
 
Computer Configuration\Policies\Windows Settings\Security Settings\Local Polici...
...
Write-Host "CIS Control 2.2.2 - User Rights Assignment" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2.2.2 (L1) Ensure 'Access this computer from the network' is set to 'Administrators, Remote Desktop Users'" -ForegroundColor White
Write-Host ""
