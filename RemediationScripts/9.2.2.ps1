<#
.SYNOPSIS
    CIS Control 9.2.2 - 9.2.2 (L1) Ensure 'Windows Firewall: Private: Inbound connections' is set to 'Bl
...
Write-Host "CIS Control 9.2.2" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 9.2.2 (L1) Ensure 'Windows Firewall: Private: Inbound connections' is set to 'Block (default)'" -ForegroundColor Yellow
Write-Host ""
