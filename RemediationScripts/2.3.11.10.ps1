<#
.SYNOPSIS
    CIS Control 2.3.11.10 - 2.3.11.10 (L1) Ensure 'Network security: Minimum session security for NTLM SSP b
...
Write-Host "CIS Control 2.3.11.10" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 2.3.11.10 (L1) Ensure 'Network security: Minimum session security for NTLM SSP based (including secure RPC) clients' is set to 'Require NTLMv2 session security, Require 128-bit encryption'" -ForegroundColor Yellow
Write-Host ""
...
NTLM connections will fail if NTLMv2 protocol and strong encryption (128-bit) are not both negotiated. Client applications that are enforcing these sett"
Write-Host ""
