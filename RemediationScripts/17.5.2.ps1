...
Write-Host "Applying CIS Control 17.5.2 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.5.2 (L1) Ensure 'Audit Group Membership' is set to include 'Success'" -ForegroundColor White
    Write-Host ""
