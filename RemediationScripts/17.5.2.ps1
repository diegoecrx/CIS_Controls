<#
.SYNOPSIS
    CIS Control 17.5.2 - 17.5.2 (L1) Ensure 'Audit Group Membership' is set to include 'Success'
...
Write-Host "CIS Control 17.5.2 - Audit Policy Configuration" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "This script will configure the following audit policy:" -ForegroundColor Yellow
Write-Host "  Subcategory: Group Membership" -ForegroundColor White
Write-Host "  Setting: Success" -ForegroundColor White
Write-Host ""
Write-Host "This will enable auditing of group membership events." -ForegroundColor Yellow
Write-Host ""
...
try {
    ...
    $result = auditpol /set /subcategory:"Group Membership" /success:enable /failure:disable 2>&1
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        $verify = auditpol /get /subcategory:"Group Membership" 2>&1
        Write-Host $verify
        
        Write-Host ""
        Write-Host "CIS Control 17.5.2 applied successfully!" -ForegroundColor Green
    } else {
...
Write-Host "SUCCESS" -ForegroundColor Green
    ...
    Write-Host "Error applying CIS Control 17.5.2: $_" -ForegroundColor Red
