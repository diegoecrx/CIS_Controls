...
Write-Host "Applying CIS Control 17.9.4 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.9.4 (L1) Ensure 'Audit Security System Extension' is set to include 'Success'" -ForegroundColor White
    Write-Host ""
