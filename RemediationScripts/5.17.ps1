<#
.SYNOPSIS
    CIS Control 5.17 - 5.17 (L2) Ensure 'Remote Desktop Configuration (SessionEnv)' is set to 'Disabled
...
Write-Host "CIS Control 5.17" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 5.17 (L2) Ensure 'Remote Desktop Configuration (SessionEnv)' is set to 'Disabled'" -ForegroundColor Yellow
Write-Host ""
