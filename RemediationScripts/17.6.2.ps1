...
Write-Host "Applying CIS Control 17.6.2 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.6.2 (L1) Ensure 'Audit File Share' is set to 'Success and Failure'" -ForegroundColor White
    Write-Host ""
