<#
.SYNOPSIS
    CIS Control 17.9.1 - 17.9.1 (L1) Ensure 'Audit IPsec Driver' is set to 'Success and Failure'
...
Write-Host "Applying CIS Control 17.9.1 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.9.1 (L1) Ensure 'Audit IPsec Driver' is set to 'Success and Failure'" -ForegroundColor White
    Write-Host ""
