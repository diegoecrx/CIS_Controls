<#
.SYNOPSIS
    CIS Control 5.40 - 5.40 (L1) Ensure 'Xbox Live Auth Manager (XblAuthManager)' is set to 'Disabled'
...
Connections to Xbox Live may fail and applications that interact with that service may als...
...
Write-Host "CIS Control 5.40" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 5.40 (L1) Ensure 'Xbox Live Auth Manager (XblAuthManager)' is set to 'Disabled'" -ForegroundColor Yellow
Write-Host ""
