<#
.SYNOPSIS
    CIS Control 2.2.19 - 2.2.19 (L1) Ensure 'Deny log on locally' to include 'Guests'
...
Write-Host "CIS Control 2.2.19 - User Rights Assignment" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2.2.19 (L1) Ensure 'Deny log on locally' to include 'Guests'" -ForegroundColor White
Write-Host ""
