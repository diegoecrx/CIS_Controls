<#
.SYNOPSIS
    CIS Control 9.1.1 - 9.1.1 (L1) Ensure 'Windows Firewall: Domain: Firewall state' is set to 'On (reco
...
Write-Host "CIS Control 9.1.1" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 9.1.1 (L1) Ensure 'Windows Firewall: Domain: Firewall state' is set to 'On (recommended)'" -ForegroundColor Yellow
Write-Host ""
