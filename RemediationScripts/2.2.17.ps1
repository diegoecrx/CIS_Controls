<#
.SYNOPSIS
    CIS Control 2.2.17 - 2.2.17 (L1) Ensure 'Deny log on as a batch job' to include 'Guests'
...
Write-Host "CIS Control 2.2.17 - User Rights Assignment" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2.2.17 (L1) Ensure 'Deny log on as a batch job' to include 'Guests'" -ForegroundColor White
Write-Host ""
