<#
.SYNOPSIS
    CIS Control 5.39 - 5.39 (L1) Ensure 'Xbox Accessory Management Service (XboxGipSvc)' is set to 'Dis
...
Write-Host "CIS Control 5.39" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 5.39 (L1) Ensure 'Xbox Accessory Management Service (XboxGipSvc)' is set to 'Disabled'" -ForegroundColor Yellow
Write-Host ""
