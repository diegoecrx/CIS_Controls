<#
.SYNOPSIS
    CIS Control 9.3.7 - 9.3.7 (L1) Ensure 'Windows Firewall: Public: Logging: Size limit (KB)' is set to
...
Write-Host "CIS Control 9.3.7" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 9.3.7 (L1) Ensure 'Windows Firewall: Public: Logging: Size limit (KB)' is set to '16,384 KB or greater'" -ForegroundColor Yellow
Write-Host ""
