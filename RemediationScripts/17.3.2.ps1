...
Write-Host "Applying CIS Control 17.3.2 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.3.2 (L1) Ensure 'Audit Process Creation' is set to include 'Success'" -ForegroundColor White
    Write-Host ""
