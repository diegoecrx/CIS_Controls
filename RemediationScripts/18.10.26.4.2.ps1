<#
.SYNOPSIS
    CIS Control 18.10.26.4.2 - 18.10.26.4.2 (L1) Ensure 'System: Specify the maximum log file size (KB)' is set
...
Write-Host "Applying CIS Control 18.10.26.4.2..." -ForegroundColor Cyan
...
try {
    ...
    if ($currentValue.$valueName -eq $value) {
        Write-Host "Successfully applied CIS Control 18.10.26.4.2" -ForegroundColor Green
    ...
    Write-Host "Error applying CIS Control 18.10.26.4.2: $_" -ForegroundColor Red
