<#
.SYNOPSIS
    CIS Control 2.2.5 - 2.2.5 (L1) Ensure 'Allow log on locally' is set to 'Administrators, Users'
...
Write-Host "CIS Control 2.2.5 - User Rights Assignment" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2.2.5 (L1) Ensure 'Allow log on locally' is set to 'Administrators, Users'" -ForegroundColor White
Write-Host ""
