<#
.SYNOPSIS
    CIS Control 2.2.24 - 2.2.24 (L1) Ensure 'Impersonate a client after authentication' is set to 'Admini
...
Computer Configuration\Policies\Windows Settings\Security Se...
...
Write-Host "CIS Control 2.2.24 - User Rights Assignment" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2.2.24 (L1) Ensure 'Impersonate a client after authentication' is set to 'Administrators, LOCAL SERVICE, NETWORK SERVICE, SERVICE'" -ForegroundColor White
Write-Host ""
