<#
.SYNOPSIS
    CIS Control 9.3.2 - 9.3.2 (L1) Ensure 'Windows Firewall: Public: Inbound connections' is set to 'Blo
...
Write-Host "CIS Control 9.3.2" -ForegroundColor Cyan
Write-Host "="*80 -ForegroundColor Cyan
Write-Host ""
Write-Host "Control: 9.3.2 (L1) Ensure 'Windows Firewall: Public: Inbound connections' is set to 'Block (default)'" -ForegroundColor Yellow
Write-Host ""
