<#
.SYNOPSIS
    CIS Control 2.2.16 - 2.2.16 (L1) Ensure 'Deny access to this computer from the network' to include 'G
...
Write-Host "CIS Control 2.2.16 - User Rights Assignment" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2.2.16 (L1) Ensure 'Deny access to this computer from the network' to include 'Guests, Local account'" -ForegroundColor White
Write-Host ""
