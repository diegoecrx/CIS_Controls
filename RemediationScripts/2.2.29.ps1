<#
.SYNOPSIS
    CIS Control 2.2.29 - 2.2.29 (L2) Ensure 'Log on as a service' is configured
...
Write-Host "CIS Control 2.2.29 - User Rights Assignment" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2.2.29 (L2) Ensure 'Log on as a service' is configured" -ForegroundColor White
Write-Host ""
