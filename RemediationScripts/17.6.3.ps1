<#
.SYNOPSIS
    CIS Control 17.6.3 - 17.6.3 (L1) Ensure 'Audit Other Object Access Events' is set to 'Success and Fai
...
Write-Host "Applying CIS Control 17.6.3 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.6.3 (L1) Ensure 'Audit Other Object Access Events' is set to 'Success and Failure'" -ForegroundColor White
    Write-Host ""
