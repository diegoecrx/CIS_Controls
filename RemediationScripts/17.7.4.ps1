<#
.SYNOPSIS
    CIS Control 17.7.4 - 17.7.4 (L1) Ensure 'Audit MPSSVC Rule-Level Policy Change' is set to 'Success an
...
Write-Host "Applying CIS Control 17.7.4 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.7.4 (L1) Ensure 'Audit MPSSVC Rule-Level Policy Change' is set to 'Success and Failure'" -ForegroundColor White
    Write-Host ""
