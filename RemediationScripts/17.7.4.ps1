<#
.SYNOPSIS
    CIS Control 17.7.4 - 17.7.4 (L1) Ensure 'Audit MPSSVC Rule-Level Policy Change' is set to include 'Success and Failure'
...
Write-Host "CIS Control 17.7.4 - Audit Policy Configuration" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "This script will configure the following audit policy:" -ForegroundColor Yellow
Write-Host "  Subcategory: MPSSVC Rule-Level Policy Change" -ForegroundColor White
Write-Host "  Setting: Success and Failure" -ForegroundColor White
Write-Host ""
Write-Host "This will enable auditing of MPSSVC Rule-Level Policy Change events." -ForegroundColor Yellow
Write-Host ""
...
try {
    ...
    $result = auditpol /set /subcategory:"MPSSVC Rule-Level Policy Change" /success:enable /failure:enable 2>&1
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        $verify = auditpol /get /subcategory:"MPSSVC Rule-Level Policy Change" 2>&1
        Write-Host $verify
        
        Write-Host ""
        Write-Host "CIS Control 17.7.4 applied successfully!" -ForegroundColor Green
    } else {
...
Write-Host "SUCCESS" -ForegroundColor Green
    ...
    Write-Host "Error applying CIS Control 17.7.4: $_" -ForegroundColor Red
