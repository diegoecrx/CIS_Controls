<#
.SYNOPSIS
    CIS Control 17.7.3 - 17.7.3 (L1) Ensure 'Audit Authorization Policy Change' is set to include 'Succes
...
Write-Host "Applying CIS Control 17.7.3 - Audit Policy" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "17.7.3 (L1) Ensure 'Audit Authorization Policy Change' is set to include 'Success'" -ForegroundColor White
    Write-Host ""
