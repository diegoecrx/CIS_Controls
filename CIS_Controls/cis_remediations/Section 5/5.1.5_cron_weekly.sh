# Goal: Secure the /etc/cron.weekly directory by ensuring proper ownership and permissions.
# Filename: 5.1.5_cron_weekly.sh
...
if [[ -d "$dir" ]] && \
  ...
  echo "OK: $dir ownership and permissions configured (CIS 5.1.5)."
  exit 0
else
