#!/bin/bash
# ID: 1.1.13_var_includes.sh 1.1.5 Ensure nosuid option set on /tmp partition (Automated)

section=1_initial_setup
sub_section=1.1_filesystem_configuration
script_name=1.1.13_var_includes.sh
...
echo "Executing: mount -o remount,nosuid /tmp"
mount -o remount,nosuid /tmp || result="pending"
