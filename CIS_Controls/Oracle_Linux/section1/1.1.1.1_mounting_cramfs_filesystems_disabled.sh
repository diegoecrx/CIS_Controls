...
# CIS Control - 1.1.1.1_mounting_cramfs_filesystems_disabled.sh
# 
# This script implements proper CIS controls with comprehensive error handling
###############################################################################

SCRIPT_NAME="1.1.1.1_mounting_cramfs_filesystems_disabled.sh"
...
main_remediation() {
    ...
    log_message "INFO" "Disabling cramfs kernel module"

    local modprobe_config="/etc/modprobe.d/cramfs.conf"

    if echo "install cramfs /bin/true" > "$modprobe_config"; then
        log_message "SUCCESS" "Created modprobe config to disable cramfs"
