...
Write-Host ""
Write-Host "Summary - 18.4: Applied $successCount, Failed $failCount" -ForegroundColor Yellow

if ($Report) {
    $results | Export-Csv -Path "$PSScriptRoot\section18_18_4_report.csv" -NoTypeInformation
}
