...
Write-Host ""
Write-Host "Summary - 18.7: Applied $successCount, Failed $failCount" -ForegroundColor Yellow

if ($Report) {
    $results | Export-Csv -Path "$PSScriptRoot\section18_18_7_report.csv" -NoTypeInformation
}
