...
Write-Host ""
Write-Host "Summary - 18.1: Applied $successCount, Failed $failCount" -ForegroundColor Yellow

if ($Report) {
    $results | Export-Csv -Path "$PSScriptRoot\section18_18_1_report.csv" -NoTypeInformation
}
