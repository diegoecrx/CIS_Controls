...
Write-Host ""
Write-Host "Summary - 18.9: Applied $successCount, Failed $failCount" -ForegroundColor Yellow

if ($Report) {
    $results | Export-Csv -Path "$PSScriptRoot\section18_18_9_report.csv" -NoTypeInformation
}
