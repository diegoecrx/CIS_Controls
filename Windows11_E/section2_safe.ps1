...
# Replace the entire $userRightsInfContent section with this:
...
revision=1
[Privilege Rights]
; Nessus-Compatible Settings
SeTrustedCredManAccessPrivilege = 
SeNetworkLogonRight = *S-1-5-32-544,*S-1-5-32-555,*S-1-5-11  # Added Authenticated Users
SeTcbPrivilege = 
...
SeDenyNetworkLogonRight = *S-1-5-32-546  # Removed Local account (S-1-5-113)
SeDenyBatchLogonRight = *S-1-5-32-546
SeDenyServiceLogonRight = *S-1-5-32-546
SeDenyInteractiveLogonRight = *S-1-5-32-546
SeDenyRemoteInteractiveLogonRight = *S-1-5-32-546  # Removed Local account
