#!/bin/bash
# CIS Oracle Linux 7 - 1.1.1.5 Ensure jffs2 kernel module is not available
# This script disables the jffs2 kernel module
# Compatible with OCI (Oracle Cloud Infrastructure)

set -e

echo "=== CIS 1.1.1.5 - Disable jffs2 kernel module ==="
